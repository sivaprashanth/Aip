...
td{ border-bottom: 1px solid #800000; font-family:cursive;font-size: 18px; color:white;}
...
p {font-family:Times;font-size:22px;font-style:normal;font-weight:normal;color:000000;}
    ...
    <br>
    <center><h2 style="font-size:50px">AUTO DEFAULTERS PAGE</h2></center> 
