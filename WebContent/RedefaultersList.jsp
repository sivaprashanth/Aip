...
<html>
<head>
  <title>Redefault home page</title>
...
h2{font-family:Aharoni;color:#FFD700;}
    ...
    <br>
    <center><h2 style="font-size:50px">REDEFAULTERS PAGE</h2></center> 
...
String sq="select cust_id,d_status,cust_name,borrower_rating,accural_status,acc_no,balance_amt,days_past_due from loan_details1 where days_past_due>180";
